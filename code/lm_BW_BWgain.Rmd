...
fit_lme4_2 = lmer(Weight_g ~ TimePoint_Weeks*BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject + (1|MouseID), data = BW)
summary(fit_lme4_2)
allEffects(fit_lme4_2)
anova(fit_lme4_2)
rand(fit_lme4_2)


fit_nlme_2 = lme(Weight_g ~ TimePoint_Weeks*BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject, random = ~1|MouseID, data = BW, method = "REML")
summary(fit_nlme_2)
allEffects(fit_nlme_2)
anova(fit_nlme_2)
...
```{r}
BWgain= BW %>% filter(TimePoint_Weeks > 3) %>% arrange(MouseID, TimePoint_Weeks) %>% group_by(MouseID) %>% mutate(BW_gain = Weight_g - Weight_g[1], BW_gain_percent = BW_gain/Weight_g[1],N = n()) %>% filter(TimePoint_Weeks > 3, N > 3)
...
fitgain_lme4_2 = lmer(BW_gain ~ TimePoint_Weeks*BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject + (1|MouseID), data = BWgain)
summary(fitgain_lme4_2)
allEffects(fitgain_lme4_2)
anova(fitgain_lme4_2)
rand(fitgain_lme4_2)


fitgain_nlme_2 = lme(BW_gain ~ TimePoint_Weeks*BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject, random = ~1|MouseID, data = BWgain, method = "REML")
summary(fitgain_nlme_2)
allEffects(fitgain_nlme_2)
anova(fitgain_nlme_2)
...
fitgainp_lme4_2 = lmer(BW_gain_percent ~ TimePoint_Weeks*BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject + (1|MouseID), data = BWgain)
summary(fitgainp_lme4_2)
allEffects(fitgainp_lme4_2)
anova(fitgainp_lme4_2)
rand(fitgainp_lme4_2)


fitgainp_nlme_2 = lme(BW_gain_percent ~ TimePoint_Weeks*BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject, random = ~1|MouseID, data = BWgain, method = "REML")
summary(fitgainp_nlme_2)
allEffects(fitgainp_nlme_2)
anova(fitgainp_nlme_2)
