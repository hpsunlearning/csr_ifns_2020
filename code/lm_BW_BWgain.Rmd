...
fit_nlme = lme(Weight_g ~ TimePoint_Weeks + BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject, random = ~1|MouseID, data = BW, method = "REML")
summary(fit_nlme)
allEffects(fit_nlme)
anova(fit_nlme)
...
fitgain_nlme = lme(BW_gain ~ TimePoint_Weeks + BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject, random = ~1|MouseID, data = BWgain, method = "REML")
summary(fitgain_nlme)
allEffects(fitgain_nlme)
anova(fitgain_nlme)
...
fitgainp_lme4_f = lmer(BW_gain_percent ~ TimePoint_Weeks + BirthMode + (1|MouseID), data = BWgain %>% filter(Sex == "F"))
summary(fitgainp_lme4_f)
allEffects(fitgainp_lme4_f)
anova(fitgainp_lme4_f)
rand(fitgainp_lme4_f)

fitgainp_lme4_m = lmer(BW_gain_percent ~ TimePoint_Weeks + BirthMode + (1|MouseID), data = BWgain %>% filter(Sex == "M"))
summary(fitgainp_lme4_m)
allEffects(fitgainp_lme4_m)
anova(fitgainp_lme4_m)
rand(fitgainp_lme4_m)

fitgainp_nlme = lme(BW_gain_percent ~ TimePoint_Weeks + BirthMode + Sex + covid + LitterSize_Born + LitterSize_InProject, random = ~1|MouseID, data = BWgain, method = "REML")
summary(fitgainp_nlme)
allEffects(fitgainp_nlme)
anova(fitgainp_nlme)
